...
{
    checkOrderOfTokens(",.=<>><",
                       {TokenType::Comma, TokenType::Dot, TokenType::Eq, TokenType::Neq, TokenType::Gt, TokenType::Lt});
}

TEST(ScannerTest, WhitespacesAreHandled)
{
    checkOrderOfTokens("   .  . .\t.\r\n..", {TokenType::Dot, TokenType::Dot, TokenType::Dot, TokenType::Dot,
...
{
    checkOrderOfTokens("aaa bbb\nccccccddsa", {TokenType::Identifier, TokenType::Identifier, TokenType::Identifier});
}

TEST(ScannerTest, IdentifiersWithNumbersWork)
{
    checkOrderOfTokens("aa123a123_21lksdaf", {TokenType::Identifier});
}

TEST(ScannerTest, IdentifiersMixedWithOperatorsWork)
{
    checkOrderOfTokens("aaa>bbb<>ccc", {TokenType::Identifier, TokenType::Gt, TokenType::Identifier, TokenType::Neq,
...
TEST(ScannerTest, SimpleQueryIsTokenized)
{
    checkOrderOfTokens("select name, surname, pay from workers where name=surname",
                       {TokenType::Select, TokenType::Identifier, TokenType::Comma, TokenType::Identifier,
                        TokenType::Comma, TokenType::Identifier, TokenType::From, TokenType::Identifier,
                        TokenType::Where, TokenType::Identifier, TokenType::Eq, TokenType::Identifier});
}

TEST(ScannerTest, QueryWithNumbersIsTokenized)
{
    checkOrderOfTokens("select * from workers where name=1230",
                       {TokenType::Select, TokenType::Star, TokenType::From, TokenType::Identifier, TokenType::Where,
...
TEST(ScannerTest, MetadataWorks)
{
    ...
    checkOrderOfTokens(result, {TokenType::Neq});
}
